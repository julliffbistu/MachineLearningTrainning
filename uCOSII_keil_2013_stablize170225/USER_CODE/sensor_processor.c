...
Uint16 HandleSensor()
{
	...
	OSMutexPend(plckSensorAquire,0,&err);
	sensor.incline[0]=(short)(roll*512.0);
	sensor.incline[1]=(short)(pitch*512.0);
	sensor.incline[2]=(short)(yaw*512.0);
	/*
	sensor.omega[0]=(short)(OmegaWorld[0]*512.0);
	sensor.omega[1]=(short)(OmegaWorld[1]*512.0);
	sensor.omega[2]=(short)(OmegaWorld[2]*512.0);
	*/
	sensor.omega[0]=(short)(Omega_Vector[0]*512.0);
	sensor.omega[1]=(short)(Omega_Vector[1]*512.0);
	sensor.omega[2]=(short)(Omega_Vector[2]*512.0);
...
Uint16 GetSensorResult(struct Sensors *psensor)
{
	...
	psensor->omega[0]=sensor.omega[0];
	psensor->omega[1]=sensor.omega[1];
	psensor->omega[2]=sensor.omega[2];
...
Uint16 HandleSensorFeedback(struct StateSwapInput *pin,struct StateSwapOutput *pout)
{
	...
	pout->sensors.omega[0]=sensor.omega[0];
	pout->sensors.omega[1]=sensor.omega[1];
	pout->sensors.omega[2]=sensor.omega[2];
	OSMutexPost(plckSensorAquire);
	return 0;
}
